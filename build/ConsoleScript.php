...
function main(): void {
    $opts = getopt("", ["make:", "relative:", "name:", "compress", "stub:"]);
    global $argv;
    ...
    foreach (buildPhar($output . "/" . $pharName . ".phar", $basePath, $includedPaths, $metadata, $stub, Phar::SHA1, Phar::GZ) as $line) {
        echo $line . PHP_EOL;
    }
}
